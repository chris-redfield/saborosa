    ...
    async loadAssets() {
        try {
            await Promise.all([
                ...
                this.loadImage('coconut_walk_sheet', 'assets/saborosa-cha-coco-arm-lift-02.png'),
                this.loadJSON('coconut_walk_sprites', 'assets/saborosa-cha-coco-arm-lift-02-sprites.json')
            ]);
