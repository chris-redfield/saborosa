...
class Game {
    ...
    gameLoop(currentTime) {
        ...
        // the boot splash shows through during the load) and drop the splash
        // (logo + loading letters), which has served its purpose and now sits
        // uselessly behind an opaque canvas.
        if (!this._revealed) {
            this._revealed = true;
