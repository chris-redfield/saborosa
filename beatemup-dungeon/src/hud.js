...
class Hud {
   ...
   * in step by hand.
   *
   * ⚠️ If the sheet has not loaded, render() returns null and the whole block
   ...
   * asked about.
   *
   * ⚠️ DELIBERATELY NOT the hand-drawn bar the player gets. That art is eleven
  ...
  /**
   * "GO ☞" — shown when an arena clears and the way forward opens.
   *
   ...
   *
   * ⚠️ EACH PIECE IS INDEPENDENTLY OPTIONAL, and the layout closes up around
  ...
  /* The debug boxes USED TO LIVE HERE and have moved to src/debug.js, which owns
     ...
     ⚠️ The version that was here drew the attack box at `box.z0` as a screen Y,
