 ...
 *
 * ⚠️ `jumpY` NEVER TOUCHES x OR z, and that is a rule rather than an
 ...
 *
 * ⚠️ `hurt` AND `down` INTERRUPT AN ATTACK. Being hit out of your own punch is
...
class Fighter {
   ...
   *
   * ⚠️ ONE SOURCE OF GEOMETRY, read by both the resolver and the debug view.
