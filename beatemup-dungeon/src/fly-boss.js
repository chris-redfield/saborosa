 ...
 *
 * ⚠️ THE SHEET IS A TURN, NOT A WALK CYCLE — 7 poses sweeping profile-left (0)
 ...
 * no per-pose offset.
 *
 * ⚠️ THE FLAP IS ACROSS FILES, NOT ACROSS THE SHEET: a pose holds its column
 ...
 *
 * ⚠️ THE ROTATION IS DETERMINISTIC — swoop, sweep, swoop, sweep. A boss whose
...
class FlyBoss {
  ...
  hitbox() {
    ...
    /* ⚠️ THE AMBUSH IS THE ONE THING THAT CAN TOUCH YOU BEFORE arrived().
   ...
   * best thing about it:
   *
   * ⚠️ THE ENTRANCE IS A FREE DEMONSTRATION OF THE BOSS'S SIGNATURE ATTACK.
   ...
   *
   * ⚠️ AIMED ONCE AND NEVER CORRECTED, like Still Life's. The lane is the
   ...
   *
   * ⚠️ It runs to the far edge and does NOT stop at the player. A pass that
   ...
   *
   * ⚠️ THE isFinite GUARD IS NOT DEFENSIVE PADDING — it is here because this
