 ...
 *
 * ⚠️ KEYBOARD AND PAD ARE TRACKED SEPARATELY AND OR'D TOGETHER, exactly as in
 ...
 *
 * ⚠️ `poll()` MUST BE CALLED ONCE PER FRAME. The Gamepad API fires no button
...
class Input {
  ...
  /* Apply a mapping authored in the main game's tools/gamepad-mapper.html.
     ...
     ⚠️ ONE THING IS MERGED BACK: `jump`. The main game has no jump action, so a
