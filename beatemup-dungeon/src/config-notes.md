...
Every block comment that used to live in `src/config.js`, moved out whole and
**unedited**. Nothing here was rewritten, summarised or dropped.

## How to use this file

`config.js` carries a marker on the line each note documents:

```js
    on: true,        // ⚠N0005     <- has a TRAP, read it before changing
    beltDepth: 190,  // ~N0234      <- prose only: what it is and why
```

**Grep the id, not the key name** -- `grep -n "N0005" config-notes.md` lands on
exactly one note. Key names repeat across the file; ids do not.

⚠️ **THE MARKER IS PART OF THE KNOB.** If a key moves, its marker moves with it.
If a key is deleted, delete its note. A knob whose marker points at nothing is
worse than a knob with no marker, because the next reader will go looking.

794 notes -- 504 carry a warning, 46 are section headers.

---

## Sections

- **THE DAY PASSING (stage 2's colour grade)** — `N0015`
- **THE BELT** — `N0023`
...
- **COMBAT** — `N0254`
- **THE PLAYER'S AIR ATTACK** — `N0257`
- **THE SPECIAL  (2026-09-16)** — `N0258`
- **TIME ATTACK  (2026-09-08) -- the minigame inside the minigame** — `N0285`
- **THE WORMS ON THE BOOKCASE'S WALL  (level 3 only, 2026-09-04)** — `N0357`
- **THE ELEVATOR'S HEIGHT ON SCREEN  (src/elevador.js -- BOTH lifts read it)** — `N0367`
- **ENEMIES** — `N0391`
- **ENEMY COMBOS** — `N0400`
- **THE JUMP-IN** — `N0411`
- **LEVEL 3 — THE BOOKCASE** — `N0421`
- **HORACIO — the desert's boss** — `N0422`
- **THE GROUND COVER** — `N0495`
- **THE SIXTH LAYER — THE ONE IN THE DEAD AREA** — `N0510`
- **COMING UP OUT OF THE GROUND (2026-08-31)** — `N0516`
- **THE DEATH BURST'S OWN FRAME RATE** — `N0536`
- **A REAL EXPLOSION ON TOP OF THE DRAWN ONE** — `N0551`
- **THE DEATH BLAST** — `N0563`
- **THE BARATA CHARGE** — `N0579`
- **THE SUICIDE RUN** — `N0583`
- **THE FLIES -- background vermin** — `N0587`
- **THE MOSCA BOSS** — `N0596`
- **THE HAND-LETTERED FRONT END (2026-09-01)** — `N0661`
- **THE FRUIT SELECT (2026-08-31)** — `N0690`
- **ONE LAYER PER COCONUT (2026-09-01) -- WHAT UNBLOCKED THE PUNCH.** — `N0696`
- **CONTINUE? (2026-08-31)** — `N0704`
...
### ⚠ N0019 — `CONFIG.GRADE.PRESETS.night`
...
### ⚠ N0020 — `CONFIG.GRADE.PRESETS.night.strength`
...
### ⚠ N0021 — `CONFIG.GRADE.PRESETS.night.saturate`
...
### ⚠ N0022 — `CONFIG.GRADE.PRESETS.night.stops`
...
### ⚠ N0038 — `CONFIG.SOURCES.plate.src`
...
### ⚠ N0039 — `CONFIG.SOURCES.plate.allowReverse`
...
### N0040 — `CONFIG.SOURCES.plate.worldPxPerSecond`
...
### N0041 — `CONFIG.SOURCES.plate.resyncS`
...
### N0042 — `CONFIG.SOURCES.plate.trackGain`

How hard drift is corrected, in rate per second of error.

### N0043 — `CONFIG.SOURCES.plate.maxRate`
...
### N0044 — `CONFIG.SOURCES.bossPlate`
...
### N0045 — `CONFIG.SOURCES.bossPlate.worldPxPerSecond`

337 screen px of pan across 5.206s. Measured, like the street's.

### ⚠ N0046 — `CONFIG.SOURCES.desertPlate`
...
### N0049 — `CONFIG.SOURCES.desertPlate.resyncS`
...
### ⚠ N0050 — `CONFIG.SOURCES.level3Plate`
...
### ⚠ N0051 — `CONFIG.SOURCES.level3Plate.allowReverse`
...
### ⚠ N0057 — `CONFIG.ROOMS[0].props.kind`
...
### ⚠ N0058 — `CONFIG.ROOMS[0].props.kind`
...
### N0061 — `CONFIG.ROOMS[0].segments.kind`
...
### N0062 — `CONFIG.ROOMS[0].segments.kind`
...
### ⚠ N0063 — `CONFIG.ROOMS[0].segments.kind`
...
### N0064 — `CONFIG.ROOMS[0].segments.kind`
...
### N0065 — `CONFIG.ROOMS[0].segments.kind`
...
### N0066 — `CONFIG.ROOMS[0].segments[5].enemies`
...
### N0067 — `CONFIG.ROOMS[0].segments.kind`
...
### ⚠ N0068 — `CONFIG.ROOMS[0].segments.kind`
...
### N0080 — `CONFIG.ROOMS[1].segments.kind`
...
### ⚠ N0081 — `CONFIG.ROOMS[1].segments.kind`
...
### ⚠ N0082 — `CONFIG.ROOMS[1].segments.kind`
...
### ⚠ N0083 — `CONFIG.ROOMS[1].segments[1].enemies.kind`
...
### ⚠ N0084 — `CONFIG.ROOMS[1].segments[1].enemies.kind`
...
### ⚠ N0085 — `CONFIG.ROOMS[1].segments[1].enemies.kind`
...
### ⚠ N0086 — `CONFIG.ROOMS[1].segments[1].enemies.kind`
...
### ⚠ N0089 — `CONFIG.ROOMS[1].segments[3].enemies.kind`
...
### ⚠ N0095 — `CONFIG.ROOMS[2].exitByLift`
...
### N0101 — `CONFIG.ROOMS[2].segments[0].lock`
...
### ⚠ N0102 — `CONFIG.ROOMS[2].segments[0].enemies`
...
### N0103 — `CONFIG.ROOMS[2].segments.kind`
...
### ⚠ N0104 — `CONFIG.ROOMS[2].segments.kind`
...
### ⚠ N0106 — `CONFIG.ROOMS[3].enterByLift`
...
### N0114 — `CONFIG.ROOMS[3].segments.kind`
...
### N0122 — `CONFIG.CHARACTERS.coconut`
...
### ⚠ N0123 — `CONFIG.CHARACTERS.coconut.jumpScale`
...
### ⚠ N0124 — `CONFIG.CHARACTERS.coconut.poses`
...
### ⚠ N0125 — `CONFIG.CHARACTERS.coconut.poses.downLand`
...
### ⚠ N0126 — `CONFIG.CHARACTERS.coconutStrong`
...
### ⚠ N0127 — `CONFIG.CHARACTERS.coconutStrong`
...
### N0128 — `CONFIG.CHARACTERS.coconutStrong.airDwell`
...
### N0129 — `CONFIG.CHARACTERS.coconutStrong.walkScale`
...
### N0130 — `CONFIG.CHARACTERS.coconutStrong.knockbackScale`
...
### N0131 — `CONFIG.CHARACTERS.coconutStrong.poses`
...
### ⚠ N0132 — `CONFIG.CHARACTERS.coconutStrong.poses.special1`
...
### ⚠ N0133 — `CONFIG.CHARACTERS.coconutStrong.poses.special2`
...
### ⚠ N0134 — `CONFIG.CHARACTERS.coconutStrong.poses.special4`
...
### N0135 — `CONFIG.CHARACTERS.cigarro`
...
### ⚠ N0136 — `CONFIG.CHARACTERS.cigarro.drawScale`
...
### N0137 — `CONFIG.CHARACTERS.cigarro.poses.downLand`
...
### N0138 — `CONFIG.CHARACTERS.cigarro2`
...
### ⚠ N0139 — `CONFIG.CHARACTERS.cigarro2.drawScale`
...
### ⚠ N0140 — `CONFIG.CHARACTERS.barata`
...
### ⚠ N0141 — `CONFIG.CHARACTERS.barata`
...
### ⚠ N0142 — `CONFIG.CHARACTERS.barata.shadowWRel`
...
### ⚠ N0143 — `CONFIG.CHARACTERS.barata.drawScale`
...
### ⚠ N0144 — `CONFIG.CHARACTERS.barata.corpseFadeSteps`
...
### ⚠ N0148 — `CONFIG.CHARACTERS.barata2.corpseFadeSteps`
...
### N0149 — `CONFIG.CHARACTERS.barata2.poses.combo4`

THE FOURTH DRAWING, wired 2026-09-10. Same one-frame shape
as the other three: this row is four strikes, not pairs.

### ⚠ N0150 — `CONFIG.CHARACTERS.verme`
...
### ⚠ N0151 — `CONFIG.CHARACTERS.verme.groundNudgePx`
...
### ⚠ N0152 — `CONFIG.CHARACTERS.verme.stage1`
...
### ⚠ N0153 — `CONFIG.CHARACTERS.verme.shadow`
...
### ⚠ N0158 — `CONFIG.CHARACTERS.barril`
...
### ⚠ N0159 — `CONFIG.CHARACTERS.barril.drawScale`
...
### ⚠ N0162 — `CONFIG.CHARACTERS.barril.poses.bomb`
...
### ⚠ N0163 — `CONFIG.CHARACTERS.espeto`
...
### ⚠ N0164 — `CONFIG.CHARACTERS.espeto.drawScale`
...
### ⚠ N0165 — `CONFIG.CHARACTERS.espeto.corpseFade`
...
### ⚠ N0166 — `CONFIG.CHARACTERS.espeto.groundNudge`
...
### ⚠ N0167 — `CONFIG.CHARACTERS.charutobi`
...
### ⚠ N0168 — `CONFIG.CHARACTERS.charutobi.drawScale`
...
### N0169 — `CONFIG.CHARACTERS.charutobi.poses`
...
### ⚠ N0170 — `CONFIG.CHARACTERS.charutobi.poses.death`
...
### ⚠ N0171 — `CONFIG.CHARACTERS.charutobi.poses.death`
...
### ⚠ N0174 — `CONFIG.POSE_RAGGED.idleLong`
...
### ⚠ N0175 — `CONFIG.POSE_RAGGED.special1`
...
### N0177 — `CONFIG.POSE_RAGGED.liftThrow`
...
### ⚠ N0178 — `CONFIG.POSE_RAGGED.carryThrow`
...
### ⚠ N0179 — `CONFIG.POSE_RAGGED.carryThrow`
...
### ⚠ N0188 — `CONFIG.IDLE_LONG.frameMs`
...
### ⚠ N0206 — `CONFIG.PROPS.barrel.sizePx`
...
### N0207 — `CONFIG.PROPS.barrel.liftRangeX`
...
### ⚠ N0208 — `CONFIG.PROPS.barrel.liftRangeX`
...
### ⚠ N0209 — `CONFIG.PROPS.barrel.dropAheadPx`
...
### ⚠ N0210 — `CONFIG.PROPS.barrel.carryYRel`
...
### ⚠ N0211 — `CONFIG.PROPS.barrel.carryYRel`
...
### ⚠ N0212 — `CONFIG.PROPS.barrel.LIFT_ARC`
...
### N0213 — `CONFIG.PROPS.barrel.LIFT_ARC.startRel`
...
### N0214 — `CONFIG.PROPS.barrel.LIFT_ARC.bulgePx`
...
### N0215 — `CONFIG.PROPS.barrel.LIFT_ARC.spinDeg`
...
### ⚠ N0216 — `CONFIG.PROPS.barrel.LIFT_ARC.steps`
...
### N0217 — `CONFIG.PROPS.barrel.throwSpeed`
...
### ⚠ N0218 — `CONFIG.PROPS.barrel.throwSpeed`
...
### N0219 — `CONFIG.PROPS.barrel.throwDamage`
...
### ⚠ N0220 — `CONFIG.PROPS.barrel.throwReachY`
...
### N0221 — `CONFIG.PROPS.barrel.throwPierce`
...
### ⚠ N0222 — `CONFIG.PROPS.barrel.dropChance`
...
### ⚠ N0223 — `CONFIG.PROPS.barrel.bombChance`
...
### N0225 — `CONFIG.PROPS.bomb.sizePx`
...
### N0226 — `CONFIG.PROPS.bomb.hp`

One punch, like a barrel: it is a bomb, and it goes off.

### N0227 — `CONFIG.PROPS.bomb.fuseMs`
...
### ⚠ N0228 — `CONFIG.PROPS.bomb.animMs`
...
### ⚠ N0229 — `CONFIG.PROPS.bomb.animPanicS`
...
### ⚠ N0230 — `CONFIG.PROPS.bomb.panicTintAlpha`
...
### ⚠ N0235 — `CONFIG.PROPS.food.chickenRel`
...
### ⚠ N0236 — `CONFIG.PROPS.food.rangeX`
...
### N0237 — `CONFIG.PROPS.food.rangeY`
...
### ⚠ N0263 — `CONFIG.SPECIAL.coconutStrong.pose`
...
### N0264 — `CONFIG.SPECIAL.coconutStrong.pose`

2 -- mid-spin.

### N0265 — `CONFIG.SPECIAL.coconutStrong.pose`
...
### ⚠ N0266 — `CONFIG.SPECIAL.coconutStrong.pose`
...
### ⚠ N0280 — `CONFIG.HIT_FX.colorByRole`
...
### ⚠ N0286 — `CONFIG.TIME_ATTACK.CHARACTERS`
...
### ⚠ N0287 — `CONFIG.TIME_ATTACK.character`
...
### ⚠ N0288 — `CONFIG.TIME_ATTACK.ASSET_BASE`
...
### ⚠ N0289 — `CONFIG.TIME_ATTACK.ASSET_BASE`
...
### N0290 — `CONFIG.TIME_ATTACK.FLY_SHEET`

THE FLIES AND THE COINS, read in place out of Still Life's folder.

### ⚠ N0291 — `CONFIG.TIME_ATTACK.keyFly`
...
### ⚠ N0294 — `CONFIG.TIME_ATTACK.quotaLabel`
...
### ⚠ N0295 — `CONFIG.TIME_ATTACK.LETTER`
...
### ⚠ N0296 — `CONFIG.TIME_ATTACK.LETTER`
...
### ⚠ N0297 — `CONFIG.TIME_ATTACK.LETTER.clockMul`
...
### ⚠ N0298 — `CONFIG.TIME_ATTACK.LETTER.holePadMul`
...
### ⚠ N0299 — `CONFIG.TIME_ATTACK.LETTER.holeAirPx`
...
### ⚠ N0300 — `CONFIG.TIME_ATTACK.LETTER.PUNCH`
...
### ⚠ N0301 — `CONFIG.TIME_ATTACK.LETTER.CLOCK_PUNCH`
...
### ⚠ N0306 — `CONFIG.TIME_ATTACK.musicKey`
...
### ⚠ N0307 — `CONFIG.TIME_ATTACK.inBeatMs`
...
### ⚠ N0310 — `CONFIG.TIME_ATTACK.pointsPerCoin`
...
### N0311 — `CONFIG.TIME_ATTACK.spawnFromRel`
...
### ⚠ N0312 — `CONFIG.TIME_ATTACK.spawnFromRel`
...
### ⚠ N0315 — `CONFIG.TIME_ATTACK.lostWord`
...
### ⚠ N0316 — `CONFIG.TIME_ATTACK.lostWord`
...
### ⚠ N0317 — `CONFIG.TIME_ATTACK.GAME_H`
...
### ⚠ N0318 — `CONFIG.TIME_ATTACK.planeHealth`
...
### ⚠ N0319 — `CONFIG.TIME_ATTACK.planeHealth`
...
### ⚠ N0320 — `CONFIG.TIME_ATTACK.flyTouchDamage`
...
### ⚠ N0321 — `CONFIG.TIME_ATTACK.barrels`
...
### ⚠ N0322 — `CONFIG.TIME_ATTACK.barrelHardFilter`
...
### ⚠ N0323 — `CONFIG.TIME_ATTACK.barrelHardChance`
...
### N0324 — `CONFIG.TIME_ATTACK.barrelFirstMs`
...
### ⚠ N0325 — `CONFIG.TIME_ATTACK.barrelMax`
...
### ⚠ N0326 — `CONFIG.TIME_ATTACK.barrelSpeed`
...
### ⚠ N0327 — `CONFIG.TIME_ATTACK.barrelSpeedVar`
...
### ⚠ N0328 — `CONFIG.TIME_ATTACK.barrelSpinChance`
...
### ⚠ N0329 — `CONFIG.TIME_ATTACK.barrelSpinMs`
...
### ⚠ N0330 — `CONFIG.TIME_ATTACK.barrelScale`
...
### ⚠ N0331 — `CONFIG.TIME_ATTACK.barrelHitWRel`
...
### ⚠ N0332 — `CONFIG.TIME_ATTACK.barrelHitWRel`
...
### ⚠ N0333 — `CONFIG.TIME_ATTACK.barrelHealth`
...
### ⚠ N0334 — `CONFIG.TIME_ATTACK.barrelHitFxSize`
...
### N0335 — `CONFIG.TIME_ATTACK.planeScale`

--- THE PLANE -- position, entry, feel ------------------------

### ⚠ N0336 — `CONFIG.TIME_ATTACK.stepped`
...
### N0337 — `CONFIG.TIME_ATTACK.planeHitWRel`

--- THE PLANE -- damage, shake, fall --------------------------

### ⚠ N0338 — `CONFIG.TIME_ATTACK.planeWearFilter`
...
### N0339 — `CONFIG.TIME_ATTACK.GUN_FRAMES`

--- THE GUN ---------------------------------------------------

### ⚠ N0340 — `CONFIG.TIME_ATTACK.rayMuzzleXRel`
...
### N0341 — `CONFIG.TIME_ATTACK.FLY_RECTS`

--- THE FLIES -------------------------------------------------

### ⚠ N0342 — `CONFIG.TIME_ATTACK.flyScale`
...
### ⚠ N0343 — `CONFIG.TIME_ATTACK.flyScale`
...
### ⚠ N0344 — `CONFIG.TIME_ATTACK.flyHealth`
...
### ⚠ N0345 — `CONFIG.TIME_ATTACK.corpsePlaneTop`
...
### N0346 — `CONFIG.TIME_ATTACK.COIN_CELL`

--- THE CLOCK COINS -------------------------------------------

### ⚠ N0347 — `CONFIG.TIME_ATTACK.coinSizePx`
...
### ⚠ N0348 — `CONFIG.TIME_ATTACK.coinSpeedVar`
...
### ⚠ N0349 — `CONFIG.TIME_ATTACK.coinOffscreenPx`
...
### ⚠ N0350 — `CONFIG.TIME_ATTACK.coinMinGapPx`
...
### ⚠ N0351 — `CONFIG.TIME_ATTACK.coinSpawnTries`
...
### N0352 — `CONFIG.TIME_ATTACK.BOOM_RECTS`

--- SHARED BURST/BOB ------------------------------------------

### N0353 — `CONFIG.TIME_ATTACK.CH_FRAMES`

--- the rest, inherited verbatim ------------------------------

### ⚠ N0354 — `CONFIG.DEV_UNLOCK`
...
### ⚠ N0360 — `CONFIG.VERMES.perLiftScreen`
...
### N0363 — `CONFIG.VERMES.jitterXRel`
...
### ⚠ N0369 — `CONFIG.ELEVADOR.riseSpeed`
...
### ⚠ N0370 — `CONFIG.ELEVADOR.standHalfRel`
...
### ⚠ N0372 — `CONFIG.LIFT_RIDE.descendMs`
...
### ⚠ N0373 — `CONFIG.LIFT_RIDE.arriveDropPx`
...
### ⚠ N0374 — `CONFIG.LIFT_RIDE.arriveScreenX`
...
### N0375 — `CONFIG.LIFT_RIDE.boardHoldMs`
...
### ⚠ N0376 — `CONFIG.LIFT_RIDE.risePxPerSec`
...
### ⚠ N0377 — `CONFIG.LIFT_RIDE.exitPadPx`
...
### ⚠ N0378 — `CONFIG.LIFT_RIDE.liftScreenX`
...
### ⚠ N0379 — `CONFIG.LIFT_RIDE.liftScreenX`
...
### ⚠ N0380 — `CONFIG.LIFT_RIDE.markScreenX`
...
### ⚠ N0381 — `CONFIG.LIFT_RIDE.widthPx`
...
### ⚠ N0396 — `CONFIG.enemySpeedScale.charutobi`
...
### N0398 — `CONFIG.enemyDamage.espeto`
...
### N0401 — `CONFIG.ENEMY_COMBOS.cigarro.pose`
...
### N0402 — `CONFIG.ENEMY_COMBOS.cigarro2`
...
### ⚠ N0403 — `CONFIG.ENEMY_COMBOS.espeto`
...
### N0404 — `CONFIG.ENEMY_COMBOS.espeto.pose`
...
### N0405 — `CONFIG.ENEMY_COMBOS.espeto.pose`
...
### ⚠ N0407 — `CONFIG.ENEMY_COMBOS.barata`
...
### ⚠ N0408 — `CONFIG.ENEMY_COMBOS.barata`
...
### ⚠ N0409 — `CONFIG.ENEMY_COMBOS.barata.pose`
...
### ⚠ N0410 — `CONFIG.ENEMY_COMBOS.verme`
...
### N0412 — `CONFIG.ENEMY_LEAP.cigarro2`
...
### N0413 — `CONFIG.ENEMY_LEAP.cigarro3`
...
### N0415 — `CONFIG.enemyLeapChance.cigarro3`
...
### N0416 — `CONFIG.enemyLeapChance.espeto`
...
### N0419 — `CONFIG.enemyLeapMaxSpeed`
...
### ⚠ N0423 — `CONFIG.HORACIO_BOSS.health`
...
### N0424 — `CONFIG.HORACIO_BOSS.enterLevel`

THE BODY HE ARRIVES IN: level 1, the small spikes, as specified.

### ⚠ N0425 — `CONFIG.HORACIO_BOSS.sheetAtlases`
...
### ⚠ N0426 — `CONFIG.HORACIO_BOSS.sheetAtlases`
...
### ⚠ N0427 — `CONFIG.HORACIO_BOSS.sizeByLevel`
...
### N0428 — `CONFIG.HORACIO_BOSS.shadow`
...
### ⚠ N0429 — `CONFIG.HORACIO_BOSS.fxColour`
...
### N0430 — `CONFIG.HORACIO_BOSS.hurtAt`
...
### ⚠ N0431 — `CONFIG.HORACIO_BOSS.nakedAt`
...
### ⚠ N0432 — `CONFIG.HORACIO_BOSS.nakedLevel`
...
### ⚠ N0433 — `CONFIG.HORACIO_BOSS.hitPoseMs`
...
### ⚠ N0434 — `CONFIG.HORACIO_BOSS.HIT_FX`
...
### ⚠ N0435 — `CONFIG.HORACIO_BOSS.SUMMON`
...
### N0436 — `CONFIG.HORACIO_BOSS.SUMMON.count`
...
### ⚠ N0437 — `CONFIG.HORACIO_BOSS.SUMMON.jitterZRel`
...
### N0438 — `CONFIG.HORACIO_BOSS.SUMMON.speed`
...
### ⚠ N0439 — `CONFIG.HORACIO_BOSS.SUMMON.triggerX`
...
### ⚠ N0440 — `CONFIG.HORACIO_BOSS.SUMMON.signalState`
...
### ⚠ N0441 — `CONFIG.HORACIO_BOSS.SUMMON.recoverMs`
...
### ⚠ N0442 — `CONFIG.HORACIO_BOSS.SUMMON.clearY`
...
### ⚠ N0443 — `CONFIG.HORACIO_BOSS.outFacing`
...
### N0444 — `CONFIG.HORACIO_BOSS.spawnZRel`
...
### ⚠ N0445 — `CONFIG.HORACIO_BOSS.dieMs`
...
### ⚠ N0446 — `CONFIG.HORACIO_BOSS.THEATRE`
...
### ⚠ N0447 — `CONFIG.HORACIO_BOSS.hittableSunk`
...
### N0448 — `CONFIG.HORACIO_BOSS.BALL`

THE BALL PHASE -- beats 3, 4, 5 and the walking half of 7.

### ⚠ N0449 — `CONFIG.HORACIO_BOSS.BALL.roamSpeed`
...
### ⚠ N0450 — `CONFIG.HORACIO_BOSS.BALL.roamMinPx`
...
### ⚠ N0451 — `CONFIG.HORACIO_BOSS.BALL.roamSunk`
...
### ⚠ N0454 — `CONFIG.HORACIO_BOSS.RISE`
...
### ⚠ N0455 — `CONFIG.HORACIO_BOSS.RISE.clearAt`
...
### ⚠ N0456 — `CONFIG.HORACIO_BOSS.RISE.hopPx`
...
### ⚠ N0457 — `CONFIG.HORACIO_BOSS.RISE.steps`
...
### ⚠ N0458 — `CONFIG.HORACIO_BOSS.RISE.unballAtStart`
...
### ⚠ N0459 — `CONFIG.HORACIO_BOSS.RISE.holdMs`
...
### N0460 — `CONFIG.HORACIO_BOSS.LANES`
...
### ⚠ N0461 — `CONFIG.HORACIO_BOSS.CHARGE`
...
### ⚠ N0462 — `CONFIG.HORACIO_BOSS.CHARGE.sunk`
...
### ⚠ N0463 — `CONFIG.HORACIO_BOSS.CHARGE.hitUpRel`
...
### N0464 — `CONFIG.HORACIO_BOSS.STAB`
...
### N0468 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.count`
...
### ⚠ N0469 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.startMs`
...
### ⚠ N0470 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.everyMs`
...
### ⚠ N0471 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.spreadXRel`
...
### N0472 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.baseYRel`
...
### N0473 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.sizePx`
...
### ⚠ N0474 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.vanishAt`
...
### ⚠ N0475 — `CONFIG.HORACIO_BOSS.DEATH_BOOM.vanishAt`
...
### ⚠ N0476 — `CONFIG.HORACIO_BOSS.DEATH_FUSE`
...
### N0477 — `CONFIG.HORACIO_BOSS.DEATH_FUSE.ms`
...
### ⚠ N0478 — `CONFIG.HORACIO_BOSS.FACING_DEG`
...
### N0479 — `CONFIG.LEVEL3.plateSource`
...
### ⚠ N0485 — `CONFIG.LEVEL3.legs[0].arena`
...
### N0486 — `CONFIG.LEVEL3.legs[0].arena.enemies.kind`
...
### ⚠ N0488 — `CONFIG.LEVEL3.legs[1].riders`
...
### ⚠ N0489 — `CONFIG.LEVEL3.legs[2].arena`
...
### ⚠ N0490 — `CONFIG.LEVEL3.legs[2].arena.enemies.kind`
...
### ⚠ N0491 — `CONFIG.LEVEL3.legs[4].arena.enemies.kind`
...
### N0493 — `CONFIG.LEVEL3.platform.boilMs`
...
### N0494 — `CONFIG.LEVEL3.platform.camStillPx`
...
### ⚠ N0497 — `CONFIG.SCENERY.DENSE.spacing`
...
### ⚠ N0507 — `CONFIG.SCENERY.parallax.rates`
...
### ⚠ N0508 — `CONFIG.SCENERY.bandScale`
...
### ⚠ N0509 — `CONFIG.SCENERY.bandOffsetZ`
...
`N0510` · `CONFIG.SCENERY.backLayer`
...
### ⚠ N0513 — `CONFIG.SCENERY.backLayer.parallax`
...
### N0514 — `CONFIG.SCENERY.backLayer.scale`
...
### N0515 — `CONFIG.SCENERY.backLayer.spacing`
...
### ⚠ N0525 — `CONFIG.EMERGE.boomStride`
...
### ⚠ N0527 — `CONFIG.EMERGE.boomDelayMs`
...
### ⚠ N0528 — `CONFIG.EMERGE.boomDelayMs`
...
### ⚠ N0534 — `CONFIG.EMERGE.spawnBehindScenery`
...
### ⚠ N0535 — `CONFIG.EMERGE.minBandsInFront`
...
### ⚠ N0537 — `CONFIG.DEATH_BURST.espeto`
...
### ⚠ N0538 — `CONFIG.DEATH_BURST.espeto.from`
...
### ⚠ N0539 — `CONFIG.DEATH_BURST.espeto.hideBurst`
...
### ⚠ N0542 — `CONFIG.DEATH_BURST.espeto.shudder.pose`
...
### ⚠ N0543 — `CONFIG.DEATH_BURST.espeto.shudder.tint`
...
### ⚠ N0544 — `CONFIG.DEATH_BURST.charutobi`
...
### ⚠ N0545 — `CONFIG.DEATH_BURST.charutobi.from`
...
### ⚠ N0546 — `CONFIG.DEATH_BURST.charutobi.ms`
...
### ⚠ N0547 — `CONFIG.DEATH_BURST.charutobi.hideAfterRow`
...
### ⚠ N0548 — `CONFIG.DEATH_BURST.charutobi.shudder`
...
### ⚠ N0549 — `CONFIG.DEATH_BURST.charutobi.shudder.from`
...
### N0550 — `CONFIG.DEATH_BURST.charutobi.shudder.tint`
...
### ⚠ N0557 — `CONFIG.DEATH_BOOM.espeto.sizePx`
...
### N0558 — `CONFIG.DEATH_BOOM.charutobi`
...
### ⚠ N0559 — `CONFIG.DEATH_BOOM.charutobi.atFrame`
...
### ⚠ N0560 — `CONFIG.DEATH_BOOM.charutobi.atFrame`
...
### ⚠ N0561 — `CONFIG.DEATH_BOOM.charutobi.baseYRel`
...
### ⚠ N0562 — `CONFIG.DEATH_BOOM.charutobi.sizePx`
...
### ⚠ N0564 — `CONFIG.DEATH_BLAST.espeto.atBoomPeak`
...
### ⚠ N0565 — `CONFIG.DEATH_BLAST.espeto.atBoomPeak`
...
### N0566 — `CONFIG.DEATH_BLAST.espeto.reachX`
...
### ⚠ N0567 — `CONFIG.DEATH_BLAST.charutobi`
...
### ⚠ N0568 — `CONFIG.DEATH_BLAST.charutobi.atFrame`
...
### ⚠ N0569 — `CONFIG.DEATH_BLAST.charutobi.atFrame`
...
### ⚠ N0570 — `CONFIG.DEATH_BLAST.charutobi.activeMs`
...
### N0571 — `CONFIG.DEATH_BLAST.charutobi.damage`
...
### ⚠ N0572 — `CONFIG.DEATH_BLAST.charutobi.reachX`
...
### N0573 — `CONFIG.DEATH_BLAST.charutobi.radial`
...
### ⚠ N0574 — `CONFIG.enemyComboWeights.espeto`
...
### ⚠ N0575 — `CONFIG.enemyComboWeights.cigarro3`
...
### N0576 — `CONFIG.enemyComboWeights.barata`
...
### ⚠ N0577 — `CONFIG.enemyComboWeights.barata`
...
### ⚠ N0578 — `CONFIG.enemyComboWeights.verme`
...
### N0580 — `CONFIG.BARATA_CHARGE.chance`
...
### ⚠ N0581 — `CONFIG.BARATA_CHARGE.curlMs`
...
### N0582 — `CONFIG.BARATA_CHARGE.minX`
...
### ⚠ N0584 — `CONFIG.SUICIDE_RUSH.charutobi.speed`
...
### ⚠ N0585 — `CONFIG.SUICIDE_RUSH.charutobi.speed`
...
### ⚠ N0586 — `CONFIG.SUICIDE_RUSH.charutobi.triggerX`
...
### N0601 — `CONFIG.flyBossDeathBoom.fadeMs`
...
### N0603 — `CONFIG.HORSE_BOSS.sizePx`
...
### ⚠ N0604 — `CONFIG.HORSE_BOSS.health`
...
### N0605 — `CONFIG.HORSE_BOSS.shadow`
...
### N0606 — `CONFIG.HORSE_BOSS.hitWRel`
...
### N0607 — `CONFIG.HORSE_BOSS.enterMargin`
...
### N0608 — `CONFIG.HORSE_BOSS.enterSpeed`
...
### ⚠ N0609 — `CONFIG.HORSE_BOSS.ACTIONS`
...
### ⚠ N0610 — `CONFIG.HORSE_BOSS.chargeNearWeight`
...
### ⚠ N0611 — `CONFIG.HORSE_BOSS.chargeCooldownFarScale`
...
### ⚠ N0612 — `CONFIG.HORSE_BOSS.chargeCooldownMs`
...
### ⚠ N0613 — `CONFIG.HORSE_BOSS.approachStopMin`
...
### ⚠ N0614 — `CONFIG.HORSE_BOSS.approachMinTravel`
...
### N0615 — `CONFIG.HORSE_BOSS.approachMaxMs`
...
### N0617 — `CONFIG.HORSE_BOSS.kickRange`
...
### ⚠ N0618 — `CONFIG.HORSE_BOSS.chargeMinRange`
...
### ⚠ N0619 — `CONFIG.HORSE_BOSS.chargeReachX`
...
### N0620 — `CONFIG.HORSE_BOSS.chargeOverrun`
...
### N0621 — `CONFIG.HORSE_BOSS.kickTellMs`
...
### ⚠ N0622 — `CONFIG.HORSE_BOSS.kickReachX`
...
### ⚠ N0626 — `CONFIG.HORSE_BOSS.dieTipRad`
...
### ⚠ N0627 — `CONFIG.HORSE_BOSS.DEATH_BOOM`
...
### ⚠ N0628 — `CONFIG.HORSE_BOSS.DEATH_BOOM.startMs`
...
### N0629 — `CONFIG.HORSE_BOSS.DEATH_BOOM.spreadXRel`
...
### N0630 — `CONFIG.HORSE_BOSS.DEATH_BOOM.sizePx`
...
### N0631 — `CONFIG.HORSE_BOSS.DEATH_BOOM.fadeMs`
...
### N0634 — `CONFIG.flyBossEnterMargin`
...
### N0635 — `CONFIG.flyBossAmbushDamage`
...
### N0639 — `CONFIG.flyBossSweepSetSpeed`
...
### ⚠ N0664 — `CONFIG.LETTERS.titleYRel`
...
### ⚠ N0665 — `CONFIG.LETTERS.titleNudgePx`
...
### ⚠ N0670 — `CONFIG.LETTERS.menuHoldMs`
...
### ⚠ N0671 — `CONFIG.LETTERS.selectedMul`
...
### N0672 — `CONFIG.LETTERS.chooseYRel`
...
### ⚠ N0673 — `CONFIG.LETTERS.pickNameXRel`
...
### ⚠ N0674 — `CONFIG.LETTERS.pickNameYRel`
...
### N0675 — `CONFIG.LETTERS.hudNameGap`
...
### ⚠ N0677 — `CONFIG.LETTERS.optTitleYRel`
...
### ⚠ N0678 — `CONFIG.LETTERS.optTitleYRel`
...
### ⚠ N0679 — `CONFIG.LETTERS.optRowGapRel`
...
### ⚠ N0685 — `CONFIG.titleWalkExitXRel`
...
### ⚠ N0687 — `CONFIG.titleWalkGroundYRel`
...
### N0688 — `CONFIG.titleWalkRepeatMs`
...
### ⚠ N0689 — `CONFIG.titleWalkRepeatMs`
...
### ⚠ N0697 — `CONFIG.SELECT.defaultPick`
...
### N0700 — `CONFIG.SELECT.chosenHoldMs`
...
### N0701 — `CONFIG.SELECT.promptYRel`
...
### ⚠ N0707 — `CONFIG.CONTINUE.figureMs`
...
### ⚠ N0709 — `CONFIG.CONTINUE.deadHoldMs`
...
### ⚠ N0710 — `CONFIG.CONTINUE.deadLightMs`
...
### ⚠ N0711 — `CONFIG.CONTINUE.deadPunch`
...
### ⚠ N0713 — `CONFIG.CONTINUE.veilAlpha`
...
### ⚠ N0714 — `CONFIG.CONTINUE.veilAlpha`
...
### ⚠ N0715 — `CONFIG.CONTINUE.fadeInMs`
...
### N0725 — `CONFIG.ENDING.groundYRel`
...
### ⚠ N0726 — `CONFIG.ENDING.groundYRel`
...
### ⚠ N0728 — `CONFIG.ENDING.poseHoldMs`
...
### ⚠ N0736 — `CONFIG.MUSIC_TRACKS.musicDesert`
...
### ⚠ N0737 — `CONFIG.MUSIC_TRACKS.musicTimeAttack`
...
### ⚠ N0738 — `CONFIG.MUSIC_TRACKS.musicLevel3`
...
### ⚠ N0739 — `CONFIG.MUSIC_TRACKS.musicEnding`
...
### ⚠ N0750 — `CONFIG.MUSIC_GAIN.musicTitle`
...
### ⚠ N0751 — `CONFIG.MUSIC_GAIN.musicDesert`
...
### ⚠ N0752 — `CONFIG.MUSIC_GAIN.musicDesert`
...
### ⚠ N0753 — `CONFIG.MUSIC_GAIN.musicTimeAttack`
...
### N0754 — `CONFIG.MUSIC_GAIN.musicEnding`
...
### ⚠ N0771 — `CONFIG.SFX_GAIN.gameOver`
...
### N0773 — `CONFIG.SFX_GAIN.enemyHit`
...
### ⚠ N0774 — `CONFIG.SFX_GAIN.playerHit`
...
### N0775 — `CONFIG.SFX_GAIN.playerHit`
...
### ⚠ N0776 — `CONFIG.SFX_GAIN.playerDeath`
...
### N0777 — `CONFIG.SFX_GAIN.enemyDeath`
...
### ⚠ N0788 — `CONFIG.PLAYER_DEATH_VOICE`
